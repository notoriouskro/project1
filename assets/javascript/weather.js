...
$('#park-search-btn').on('click', function () {
    ...
    var queryURL = 'https://api.aerisapi.com/forecasts/'+ lat[1] + ', ' + long[1] +'?&client_id=8I6t90Z8W84ZVlcgjzpqs&client_secret=8KAQf3xSfGPQSCzL7jXJ4AdUe3JMLajykSLvjuq6&from='+from+'&to=+'+days+'days&filter=daynight';
